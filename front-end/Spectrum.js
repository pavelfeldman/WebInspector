...
WebInspector.Spectrum = function(swatch, rgb)
{
    ...
    this.button = this.element.querySelectorAll(".sp-range-container div")[0];
    ...
    this.button.addEventListener("click", this.hide.bind(this), false);
    ...
    { 
        ...
        if (!rightclick && !dragging) { 
            if (onstart.apply(element, arguments) !== false) {
                ...
                scrollOffset = WebInspector.Spectrum.getScrollOffset(element);
...
WebInspector.Spectrum.prototype = {
    ...
    toggle: function(e) {
		var isShown = this.element.hasStyleClass('sp-show');
        if (isShown) 
            this.hide(e);
        else
            this.show(e);
    ...
    show: function(e) {
        ...
        var x = Math.min(
            this.swatch.offsetParent.clientWidth - this.element.clientWidth - 20, 
            Math.max(0, this.swatch.offsetLeft)
        );
        
        var y = this.swatch.offsetTop + this.swatch.clientHeight;
        
        this.element.positionAt(x, y);
        
        this.slideHeight = this.slider.offsetHeight;
        this.dragWidth = this.dragger.offsetWidth;
        this.dragHeight = this.dragger.offsetHeight;
        this.dragHelperHeight = this.dragHelper.offsetHeight / 2;
    ...
    addHideListener: function(listener) {
